...
fn check_runs_full_generation_pipeline_without_writing_files() {
    ...
    assert_eq!(
        ...
        [crate::QuerySummary::new(
            ...
            crate::BuilderSummaryCounts::new(0, 0, 0, 0, 1)
        )]
    );
    assert_eq!(
        calls.entries(),
...
fn check_accepts_slotless_mutation_source_units() {
    ...
    assert_eq!(outcome.unique_repeat_count(), 0);
    ...
    assert_eq!(
        ...
        [crate::MutationSummary::new(
            ...
            crate::BuilderSummaryCounts::new(1, 1, 0, 0, 1),
        )]
    );
    assert_eq!(
        calls.entries(),
...
fn check_accepts_mutation_slot_variants_and_builds_dynamic_ir() {
    ...
    assert_eq!(
        ...
        [crate::MutationSummary::new(
            ...
            crate::BuilderSummaryCounts::new(2, 2, 1, 0, 2),
        )]
    );
    assert_eq!(
